...
<body>
    ...
    <form class="form-horizontal" action="{{route('cidade.buscado')}}" method="POST">
        @csrf
        <fieldset>
        ...
        <div class="form-group">
          ...
          <div class="col-md-4">
          <input id="nome" name="nome" type="text" placeholder="Digite uma cidade:" class="form-control input-md">
