...
<body>
    ...
    <form class="form-horizontal" action="{{route('pais.editado', ['id'=>$pais->id])}}" method="POST">
      @csrf  
      <fieldset>
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
              <button type="submit" id="button" name="button" class="btn btn-primary">Alterar</button>
