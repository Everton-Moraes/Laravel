...
<body>
    ...
    <form class="form-horizontal" action="{{route('cidade.editado', ['id'=>$cidade->id])}}" method="POST">
        @csrf
        <fieldset>
        ...
        <div class="form-group">
          ...
          <div class="col-md-4">
          <input id="nome" name="nome" type="text" value="{{$cidade->nome}}" class="form-control input-md">
