...
<body>
    ...
    <form class="form-horizontal" action="{{route('estado.editado', ['id'=>$estado->id])}}" method="POST">
        @csrf
        <fieldset>
        ...
        <div class="form-group">
          ...
          <div class="col-md-4">
          <input id="nome" name="nome" type="text" value="{{$estado->nome}}" class="form-control input-md">
        ...
        <div class="form-group">
          ...
          <div class="col-md-4">
          <input id="iniciais" name="iniciais" type="text" value="{{$estado->iniciais}}" class="form-control input-md">
